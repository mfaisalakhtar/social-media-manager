...
export function Sidebar({ workspaceSlug, workspaceName }: SidebarProps) {
  ...
  const navItems: NavItem[] = [
    ...
    { label: "Posts",       href: `${base}/posts`,         icon: <PostsIcon /> },
    { label: "Approvals",   href: `${base}/approvals`,     icon: <ApprovalIcon /> },
    { label: "Connections", href: `${base}/connections`,   icon: <ConnectionsIcon /> },
    { label: "Media",       href: `${base}/media`,         icon: <MediaIcon /> },
    { label: "Analytics",   href: `${base}/analytics`,     icon: <AnalyticsIcon /> },
    { label: "Settings",    href: `${base}/settings`,      icon: <SettingsIcon /> },
  ];

  return (
    <aside className="w-56 shrink-0 flex flex-col h-screen sticky top-0" style={{ backgroundColor: '#00585B' }}>
      {/* Logo */}
      <div className="px-5 py-4 border-b border-white/10">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#26BB85' }}>
            <svg className="w-3.5 h-3.5 text-[#DEF58A]" fill="currentColor" viewBox="0 0 20 20">
              <path d="M10 2a6 6 0 00-6 6c0 1.887.87 3.568 2.22 4.682L5 18h10l-1.22-5.318A6 6 0 0010 2z" />
            </svg>
          </div>
          <span className="font-semibold text-white text-sm">Social Manager</span>
        </div>
      </div>
      ...
      <Link
        href="/dashboard"
        className="px-4 py-2.5 text-xs hover:text-white/80 border-b border-white/10 flex items-center gap-1.5 truncate transition-colors text-[#DEF58A]/70"
      >
      ...
      <div className="px-4 pt-4 pb-2">
        ...
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5} style={{ color: '#DEF58A' }}>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-white/15 text-white border-l-2 border-[#DEF58A]"
